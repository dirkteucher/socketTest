...
# The setup of the XloBorg needs to be done first https://www.piborg.org/index.php?q=xloborg/install
# Then the code below checks for quite a significant change in the accelerometer, the sensitivity can be modified as needed
...
# These few lines can handle json nicely
